...
class EdgeDistributionRenderer:
    def __init__(self, zoom_levels, edge_lengths, transparency_calculator, output_folder):
    ...
    def compute_x_and_y_for_plot(self, zl):
        step = max(self.edge_lenghts) // len(self.zoom_to_transparencies[zl])
        x_edge_length = list(
    ...
    def generate_distribution_img(self, edge_lengths, x, y, zoom_level):
        ...
        fig.suptitle("Zoom lvl: " + str(zoom_level), fontsize=15)
